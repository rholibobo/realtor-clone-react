...
export default function SignUp() {
  ...
  // Destructing form data to use values key-values from form
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // create copy of form dta so as to delete password info from firebase db
      ...
      toast.error("Something went wrong with the reistration")
    }
  }
  return (
    <section>
